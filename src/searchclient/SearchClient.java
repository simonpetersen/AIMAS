...
public class SearchClient {
    ...
    public SearchClient(BufferedReader serverMessages) throws Exception {
        ...
        int rows = lines.size();
        int cols = lines.stream().mapToInt(l -> l.length()).max().getAsInt();
        this.initialState = new State(null);
        this.initialState.goals = new char[rows][cols];
        this.initialState.boxes = new char[rows][cols];
        this.initialState.walls = new boolean[rows][cols];
